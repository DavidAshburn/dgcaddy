...
class LayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create layout" do
    assert_difference("Layout.count") do
      post layouts_url, params: { layout: { course_id: @layout.course_id, length: @layout.length, name: @layout.name, pars: @layout.pars } }
    end
  ...
  test "should update layout" do
    patch layout_url(@layout), params: { layout: { course_id: @layout.course_id, length: @layout.length, name: @layout.name, pars: @layout.pars } }
